...
HD_PWD='C:/Xilinx/project/mux41_if/mux41_if.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux41_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux41_case.tcl
