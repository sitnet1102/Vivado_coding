...
HD_PWD='C:/Xilinx/project/mux81_const/mux81_const.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux81_const.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux81_const.tcl
