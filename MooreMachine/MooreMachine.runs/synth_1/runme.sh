...
HD_PWD='C:/Xilinx/project/MooreMachine/MooreMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MooreMachine3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MooreMachine3.tcl
