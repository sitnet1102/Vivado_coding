...
HD_PWD='C:/Xilinx/project/and2/and2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log or2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source or2.tcl -notrace
