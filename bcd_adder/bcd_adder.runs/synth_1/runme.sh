...
HD_PWD='C:/Xilinx/project/bcd_adder/bcd_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digit_2_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digit_2_adder.tcl
