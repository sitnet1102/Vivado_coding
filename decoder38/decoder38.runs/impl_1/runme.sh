...
HD_PWD='C:/Xilinx/project/decoder38/decoder38.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dec38.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dec38.tcl -notrace
