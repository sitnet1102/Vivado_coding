...
HD_PWD='C:/Xilinx/project/effect_7seg/effect_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log effect_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source effect_7seg.tcl -notrace
