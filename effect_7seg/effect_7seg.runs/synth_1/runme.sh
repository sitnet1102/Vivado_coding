...
HD_PWD='C:/Xilinx/project/effect_7seg/effect_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log effect_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source effect_7seg.tcl
