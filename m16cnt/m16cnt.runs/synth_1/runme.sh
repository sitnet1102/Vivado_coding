...
HD_PWD='C:/Xilinx/project/m16cnt/m16cnt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m16cnt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m16cnt.tcl
