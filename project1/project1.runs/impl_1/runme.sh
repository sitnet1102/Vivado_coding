...
HD_PWD='C:/Xilinx/project/project1/project1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mod10cnt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mod10cnt.tcl -notrace
