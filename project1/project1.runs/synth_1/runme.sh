...
HD_PWD='C:/Xilinx/project/project1/project1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mod10cnt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mod10cnt.tcl
