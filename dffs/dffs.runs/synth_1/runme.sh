...
HD_PWD='C:/Xilinx/project/dffs/dffs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_presetclr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dff_presetclr_1.tcl
