...
HD_PWD='C:/Xilinx/project/ShiftRegisterLeft4/ShiftRegisterLeft4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SRL4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SRL4.tcl
