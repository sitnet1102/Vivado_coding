...
HD_PWD='C:/Xilinx/project/ShiftRegisterLeft4/ShiftRegisterLeft4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SRL4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SRL4.tcl -notrace
