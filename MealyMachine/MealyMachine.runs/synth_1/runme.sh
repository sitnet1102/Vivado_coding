...
HD_PWD='C:/Xilinx/project/MealyMachine/MealyMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MealyMachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MealyMachine.tcl
