...
HD_PWD='C:/Xilinx/project/mux81_4bit/mux81_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux81_4bit_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux81_4bit_case.tcl
