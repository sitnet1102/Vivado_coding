...
HD_PWD='C:/Xilinx/project/cnt8/cnt8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnt8.tcl -notrace
