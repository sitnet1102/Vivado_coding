...
HD_PWD='C:/Xilinx/project/project2/project2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buzzer_LDC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buzzer_LDC.tcl
