...
HD_PWD='C:/Xilinx/project/project2/project2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log buzzer_LDC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source buzzer_LDC.tcl -notrace
