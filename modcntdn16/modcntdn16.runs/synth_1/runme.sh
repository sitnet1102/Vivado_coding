...
HD_PWD='C:/Xilinx/project/modcntdn16/modcntdn16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log m15hucnt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source m15hucnt.tcl
